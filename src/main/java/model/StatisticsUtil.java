...
public class StatisticsUtil {
    ...
    public static List<Statistics> createStatistics(List<Student> students,
        ...
        logger.log(Level.INFO, "Statistics model started");
        ...
        profiles.forEach(profile -> {
            ...
            statistics.setCountOfUniversities(profileUniversityIds.size());
            ...
            List<Student> profileStudents = students.stream()
                    ...
                    .collect(Collectors.toList());
            statistics.setCountOfStudents(profileStudents.size());
        ...
        logger.log(Level.INFO, String.format("Statistics model finished with %s statistical objects", statisticsList.size()));
