...
public class XlsWriter {
    ...
    public static void writeXlsStatistics(List<Statistics> statisticsList,
        ...
        universitiesCellHeader.setCellValue("Названия университетов");
        ...
        for (Statistics statistics : statisticsList) {
            ...
            numberOfStudentsCell.setCellValue(statistics.getCountOfStudents());
            Cell numberOfUniversitiesCell = dataRow.createCell(3);
            numberOfUniversitiesCell.setCellValue(statistics.getCountOfUniversities());
